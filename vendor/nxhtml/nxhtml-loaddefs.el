...
;;;### (autoloads (appmenu-add) "appmenu" "util/appmenu.el" (18791
;;;;;;  1466))
...
(autoload (quote as-external-for-mail) "as-external" "\
...
* Example using raw:
  ...
  Chart-title: \"Vad killen i slips tjÅ‰nar jÅ‰mfÅˆrt med dig och mig\"
...
;;;;;;  "css-color" "util/css-color.el" (18795 50048))
...
;;;;;;  "css-palette" "util/css-palette.el" (18795 48910))
...
;;;;;;  "tests/ert.el" (18776 16068))
;;; Generated autoloads from tests/ert.el

(autoload (quote ert-deftest) "ert" "\
...
;;;;;;  "freemind" "util/freemind.el" (18659 38618))
;;; Generated autoloads from util/freemind.el

(autoload (quote freemind-show) "freemind" "\
Show file MM-FILE in Freemind.

\(fn MM-FILE)" t nil)

(autoload (quote freemind-from-org-mode-node) "freemind" "\
Convert node at line NODE-LINE to the FreeMind file MM-FILE.

\(fn NODE-LINE MM-FILE)" t nil)

(autoload (quote freemind-from-org-mode) "freemind" "\
Convert the `org-mode' file ORG-FILE to the FreeMind file MM-FILE.

\(fn ORG-FILE MM-FILE)" t nil)

(autoload (quote freemind-from-org-sparse-tree) "freemind" "\
Convert visible part of buffer ORG-BUFFER to FreeMind file MM-FILE.

\(fn ORG-BUFFER MM-FILE)" t nil)

(autoload (quote freemind-to-org-mode) "freemind" "\
...
;;;;;;  "gimp" "util/gimp.el" (18662 24584))
;;; Generated autoloads from util/gimp.el

(autoload (quote gimp-edit-file) "gimp" "\
Edit IMAGE-FILE with GIMP.

\(fn IMAGE-FILE)" t nil)

(autoload (quote gimp-edit-buffer) "gimp" "\
Edit image file in current buffer with GIMP.

\(fn)" t nil)

(autoload (quote gimp-can-edit) "gimp" "\
Not documented
...
;;;***

;;;### (autoloads (gpl-mode) "gpl" "util/gpl.el" (18795 48910))
...
;;;;;;  "html-site" "nxhtml/html-site.el" (18791 1464))
...
(autoload (quote htmlfontify-buffer) "htmlfontify" "\
...
characters such as ^L () or Å§ (\xa4) won't get mapped yet.
...
(autoload (quote inlimg-toggle-img-display) "inlimg" "\
...
;;;;;;  majmodpri) "majmodpri" "util/majmodpri.el" (18781 35670))
...
;;;***

;;;### (autoloads (mlinks-mode) "mlinks" "util/mlinks.el" (18791
;;;;;;  1466))
...
;;;;;;  "mumamo-fun" "util/mumamo-fun.el" (18784 28474))
...
(autoload (quote perl-mumamo-mode) "mumamo-fun" "\
Turn on multiple major modes for Perl Here Document." t)

(autoload (quote cperl-mumamo-mode) "mumamo-fun" "\
Turn on multiple major modes for Perl Here Document." t)
...
;;;;;;  nxhtml-mode) "nxhtml-mode" "nxhtml/nxhtml-mode.el" (18791
;;;;;;  1464))
...
;;;;;;  "nxhtml/nxhtml-mumamo.el" (18791 1464))
...
(autoload (quote nxhtmltest-run-Q) "nxhtmltest-Q" "\
...
;;;;;;  "tests/nxhtmltest-suites.el" (18781 35670))
;;; Generated autoloads from tests/nxhtmltest-suites.el

(autoload (quote nxhtmltest-run-indent) "nxhtmltest-suites" "\
Run indentation tests.

\(fn)" t nil)

(autoload (quote nxhtmltest-run) "nxhtmltest-suites" "\
...
;;;***

;;;### (autoloads (nxml-where-global-mode) "nxml-where" "nxhtml/nxml-where.el"
;;;;;;  (18794 15182))
...
;;;;;;  "ourcomments-util" "util/ourcomments-util.el" (18791 1466))
...
(autoload (quote major-or-multi-majorp) "ourcomments-util" "\
Not documented

\(fn VALUE)" nil nil)

(autoload (quote multi-major-modep) "ourcomments-util" "\
Return t if VALUE is a multi major mode function.

\(fn VALUE)" nil nil)

(autoload (quote major-modep) "ourcomments-util" "\
Return t if VALUE is a major mode function.

\(fn VALUE)" nil nil)

(define-widget (quote major-mode-function) (quote function) "\
...
(nxhtml-custom-autoload (quote wrap-to-fill-left-marg) "ourcomments-util" t)
...
(nxhtml-custom-autoload (quote wrap-to-fill-left-marg-modes) "ourcomments-util" t)

(autoload (quote wrap-to-fill-column-mode) "ourcomments-util" "\
...
;;;***

;;;### (autoloads (sex-mode) "sex-mode" "util/sex-mode.el" (18791
;;;;;;  1466))
...
;;;***

;;;### (autoloads (tabkey2-mode) "tabkey2" "util/tabkey2.el" (18791
;;;;;;  1466))
...
;;;;;;  resize-windows) "winsize" "util/winsize.el" (18791 1466))
...
;;;;;;  "xhtml-help" "nxhtml/xhtml-help.el" (18791 1464))
...
;;;;;;  "util/winsav.el" "util/zen-mode.el") (18823 33878 616365))

;;;***

;;;### (autoloads (nxhtmlmaint-byte-uncompile-all nxhtmlmaint-start-byte-compilation)
;;;;;;  "nxhtmlmaint" "nxhtmlmaint.el" (18794 15182))
